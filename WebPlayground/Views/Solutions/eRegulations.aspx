    ...
    <div class="page-intro">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home pr-10"></i><a href="<%: Url.Action("Index", "Solutions") %>">Soltuions</a></li>
                        <li class="active">eRegulations</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title">eRegulations: Regulations Modernization</h1>
