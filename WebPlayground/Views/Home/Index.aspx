                        ...
                        <ul>
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Premium HTML5 template">
                                ...
                                <div class="tp-caption sfr tp-resizeme"
                                    ...
                                    data-end="9400"
                                    data-endspeed="600">
                                    <img src="<%: Url.Content("~/Content/iDea/images/slider-1-layer-1.png") %>" alt="">
                                </div>
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Powerful Bootstrap Theme">
                                ...
                                <div class="tp-caption sfr tp-resizeme"
                                    ...
                                    data-end="9400"
                                    data-endspeed="600">
                                    <img src="<%: Url.Content("~/Content/iDea/images/slider-1-layer-2.png") %>" alt="">
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="vertical hc-tabs">
                            ...
                            <div class="hc-tabs-top">
                                <img data-tab="#tab1" src="<%: Url.Content("~/Content/iDea/images/section-image-1.png") %>" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
                                <img data-tab="#tab2" src="<%: Url.Content("~/Content/iDea/images/section-image-2.png") %>" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
                                <img data-tab="#tab3" src="<%: Url.Content("~/Content/iDea/images/section-image-3.png") %>" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
                                <img data-tab="#tab4" src="<%: Url.Content("~/Content/iDea/images/section-image-4.png") %>" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
                                <div class="space"></div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="testimonial-image">
                                    <img src="<%: Url.Content("~/Content/iDea/images/testimonial-1.jpg") %>" alt="Jane Doe" title="Jane Doe" class="img-circle">
                                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="testimonial-image">
                                    <img src="<%: Url.Content("~/Content/iDea/images/testimonial-2.jpg") %>" alt="Jane Doe" title="Jane Doe" class="img-circle">
                                </div>
                                <div class="testimonial-body">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="testimonial-image">
                                    <img src="<%: Url.Content("~/Content/iDea/images/testimonial-3.jpg") %>" alt="Jane Doe" title="Jane Doe" class="img-circle">
                                </div>
                                <div class="testimonial-body">
                        ...
                        <div class="owl-carousel carousel">
                            <div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="300">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-1.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-1.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="200">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-2.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-2.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="100">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-3.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-3.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="0">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-4.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-4.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-5.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-5.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-6.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-6.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-7.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-7.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                            ...
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="<%: Url.Content("~/Content/iDea/images/portfolio-8.jpg") %>" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                            <a href="<%: Url.Content("~/Content/iDea/images/portfolio-8.jpg") %>" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="owl-carousel clients">
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-1.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-2.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-3.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-4.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-5.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-6.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-7.png") %>" alt=""></a>
                            </div>
                            <div class="client">
                                <a href="#">
                                    <img src="<%: Url.Content("~/Content/iDea/images/client-8.png") %>" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
